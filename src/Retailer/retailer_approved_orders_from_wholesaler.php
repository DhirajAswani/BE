...
//                echo $query;
            $query = "SELECT * FROM `retailer_order`,wholesaler,product WHERE status=1 and retailer_order.wholesaler_id=wholesaler.uid and product.product_id=retailer_order.product_id";
                ...
                while($row = mysqli_fetch_assoc ($result)){
                    ...
                    echo"<tr>";
                              ...
                              echo "<td>{$row['product_quantity']}</td>";
                                        ...
                                        // echo"<td>{}</td>";
                                        echo"<td> <a href='qrcoderetailer.php?orderId={$row['retailer_order_id']}' class = 'btn btn-success'>Authenticate</a> </td>";
