...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="w-registeration.php" method="post">
                ...
                <div class="alert alert-danger display-hide">
                    ...
                    <label class="control-label visible-ie8 visible-ie9">Warehouse Name</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Warehouse Name" name="warehouse_name" /> </div>
                    
                    <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">Address</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Address" name="warehouse_address" /> </div>
                
                    
                    <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">Warehouse Email</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email Address" name="warehouse_email_id" /> </div>
                    
                    <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">Warehouse Contact Number</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Contact" name="warehouse_telephone_no" /> </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn green uppercase" name="wholesaler-register">Register</button>
