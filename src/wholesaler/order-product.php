                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="wholesaler-dashboard.html" class="nav-link ">
                                        <span class="title">Order Product</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">All Purchases</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Manipulated</span>
                                    </a>
                                </li>
